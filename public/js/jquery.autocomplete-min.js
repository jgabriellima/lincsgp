...
onKeyUp:function(b){
    if(!this.disabled){
        ...
        if(this.currentValue!==this.el.val())if(this.options.deferRequestBy> 0){
            var a=this;
...
onValueChange:function(){
    ...
    this.selectedIndex=-1;
    if(this.ignoreValueChange)this.ignoreValueChange=false;else b===""||b.length<this.options.minChars?this.hide():this.getSuggestions(b)
        },
getQuery:function(b){
    var a;
...
isBadQuery:function(b){
    for(var a=this.badQueries.length;a--;)if(b.indexOf(this.badQueries[a])===0)return true;return false
    },
hide:function(){
    this.enabled=false;
    this.selectedIndex=-1;
...
moveUp:function(){
    if(this.selectedIndex!==-1)if(this.selectedIndex===0){
...
adjustScroll:function(b){
    ...
    if(a<c)this.container.scrollTop(a);else a>e&&this.container.scrollTop(a-this.options.maxHeight+25);
