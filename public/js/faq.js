...
(function($) {
    ...
    $.fn.goFaq = function(options) {
        ...
        function generateEmptySearch () {
            ...
            return $empty.html ('<span style="font-size:14px;">Nenhum resultado foi encontrado. <a data-toggle="modal" href="#faqdialog" >Deseja colaborar conosco, clique aqui</a></span>');
        }
        ...
        function generateSearchForm () {
            ...
            var $input = $('<input>', {
                'type': 'text', 
                'name': 'search', 
                'placeholder': 'Entre com o que você deseja buscar'
            });
            $input.appendTo ($form);
